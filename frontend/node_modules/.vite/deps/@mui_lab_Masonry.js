...
import "./chunk-ECPL6R7W.js";
import "./chunk-JKHSGFXD.js";
import "./chunk-FMFFUJ5P.js";
import "./chunk-EZY4KXYU.js";
import "./chunk-4RJ3QIO7.js";
import "./chunk-TAJ2L4C6.js";
import {
  require_react_dom
...
var _excluded29 = ["children", "className", "component", "columns", "spacing", "sequential", "defaultColumns", "defaultHeight", "defaultSpacing"];
...
var Masonry = React75.forwardRef(function Masonry2(inProps, ref) {
  ...
  const masonryRef = React75.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React75.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React75.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = _extends({}, props, {
    spacing,
    columns,
    maxColumnHeight,
  ...
  const handleResize = React75.useCallback((masonryChildren) => {
  ...
  const lineBreaks = new Array(numberOfLineBreaks).fill("").map((_, index2) => (0, import_jsx_runtime49.jsx)("span", {
    "data-class": "line-break",
    style: _extends({}, lineBreakStyle, {
      order: index2 + 1
    })
  }, index2));
  return (0, import_jsx_runtime50.jsxs)(MasonryRoot, _extends({
    as: component,
...
true ? Masonry.propTypes = {
   ...
   * @default 4
   */
  columns: import_prop_types31.default.oneOfType([import_prop_types31.default.arrayOf(import_prop_types31.default.oneOfType([import_prop_types31.default.number, import_prop_types31.default.string])), import_prop_types31.default.number, import_prop_types31.default.object, import_prop_types31.default.string]),
  /**
   ...
   */
  defaultColumns: import_prop_types31.default.number,
  /**
   * The default height of the component in px. This is provided for server-side rendering.
   */
  defaultHeight: import_prop_types31.default.number,
  /**
   * The default spacing of the component. Like `spacing`, it is a factor of the theme's spacing. This is provided for server-side rendering.
   */
  defaultSpacing: import_prop_types31.default.number,
  /**
   * Allows using sequential order rather than adding to shortest column
   * @default false
   */
  sequential: import_prop_types31.default.bool,
  /**
